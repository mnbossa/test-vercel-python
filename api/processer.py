# api/process.py  -- minimal test handler (deploy this first)
import json

def handler(request):
    # simple check that the function loads and returns JSON
    return ("application/json", 200, json.dumps({"ok": True, "message": "process function loaded"}))
